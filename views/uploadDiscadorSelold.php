    ...
    <table class="table text-center">
        ...
        <div class="col-lg-8">
            <?php foreach ($mailing_list as $l): ?>
                ...
                <td><a href=# onclick="resumoMailing(<?php echo $l['id']; ?>)"> <?php echo substr($l['nome_arquivo'],0,35); ?></a></td>
                ...
                <td class="text-center"><a href=#" onclick="delMailing(<?php echo $l['id']; ?>)"><img src="<?php echo BASE_URL; ?>/assets/images/trash.png" class="delete" style="width:20px;heith:20px;"></a></td>
