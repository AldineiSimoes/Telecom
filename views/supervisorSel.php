    ...
    foreach ($grupos as $l) {
        if ($l['id_grupo'] != $gr) {
            ...
            $gr = $l['id_grupo'];
            $html .= '<span class="spanGrupos" id="' . $l['id_grupo'] . '">'. $l['id_grupo'] .' - ' . $l['descricao'] . '
            ...
            $html .= '<div class="tgl" style="display : none;"> ';
            $html .= '    <table id="tb1" style="text-align: center;font-size:10px;" class="tblistagentes table table-bordered dw-100" >
                            <thead class="theadfundo">
                                <tr class="cabecalho">
                                    ...
                                    <th class="theadfundo">ORIGEM</th>
                                    <th class="theadfundo">DIRECAO</th>
                                </tr>
                            </thead>';
        }
        $i++;
        $html .= '<tbody id="A' . $i . '" class="' . $l{'codigo'} . '" >';
        $html .= '<tr onclick="optionsAgentes(' . $i . ',' . $l{'id_grupo'} . ')" style="width: 400px;" id="' . $l{'id_grupo'} . $l{'id'} . '" class="trhover" >
