...
<div class="container">
    ...
    <div class="text-left row">
        <div class="col-lg-12 text-muted " style="font-size: 20px;">
            <img src="<?php echo BASE_URL; ?>/assets/images/success.png" style="width: 20px;height: 20px;margin-left: 40px;"> STATUS SERVIDOR
            <hr/>                
        </div>
    </div>
    <!--        <div class="panel panel-success">
                <div class="panel-heading text-center w-100">STATUS SERVIDOR</div>-->
    <div class="row">
        <div class="col-lg-3">
            <br/>
            <div class="panel panel-success w-100" style="font-size: 35px; ">
                <img src="<?php echo BASE_URL; ?>/assets/images/CPU.png" style="width: 40px;height: 40px;margin-left: 40px;margin-right: 20%; margin-bottom: 10%; margin-top: 10%"> 45%
                <br/>
            </div>
        </div>
        <div class="col-lg-3">
            <br/>
            <div class="panel panel-success w-100" style="font-size: 35px;">
                <img src="<?php echo BASE_URL; ?>/assets/images/ram.png" style="width: 40px;height: 40px;margin-left: 40px;margin-right: 20%; margin-bottom: 10%; margin-top: 10%"> 75%
                <br/>
            </div>
        </div>
        ...
        <div class="col-lg-3">
            <br/>
            <div class="panel panel-success w-100" style="font-size: 35px;">
                <img src="<?php echo BASE_URL; ?>/assets/images/hard-disk.png" style="width: 40px;height: 40px;margin-left: 40px;margin-right: 20%; margin-bottom: 10%; margin-top: 10%"> 30%
                <br/>
            </div>
        </div>
        ...
        <div class="col-lg-3">
            <br/>
            <div class="panel panel-success w-100">
                <br/>
                <img src="<?php echo BASE_URL; ?>/assets/images/local-network.png" style="width: 40px;height: 40px;margin-left: 40px;">
                <?php
                //   $session = new SNMP(SNMP::VERSION_1, "127.0.0.1", "public");
                //   $results = $session->get(array("sysDescr.0", "sysName.0"));
                //$results = snmpget( "172.16.0.32", "infoMONITOR", " system.SysContact.0 "); 
                //  print_r($results);
                //   $session->close();
                ?>
                <br/>
