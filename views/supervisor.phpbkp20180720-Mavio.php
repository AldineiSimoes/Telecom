...
<div id="divsuptop">
    <div class="divform">
        <form method="POST" id="formcamp" data-type="listMonitor" >
            Selecione a campanha: <!--<label for="group">GRUPO MONITORADO - <?php echo $idgroup.' - '.$groupName ?></label>--><br>
            <select name="supcamp" id="supcamp" class="form-control" required>
            <?php foreach ($campanha_list as $l): ?>
              <option id="opcamp" value="<?php echo $l['ID_CAMPANHA']; ?>" <?php ($l['ID_CAMPANHA']==$idcamp)?'selected="selected"':''; ?>>
...
<div  class="listaAgentes">
    <div id="groupsel" class="groupsel">
        <br/>
        <br/>
