...
//        parent::__construct();
    ...
    public function listMonitor(){
        ...
        if(isset($_POST['a'])) {
            ...
            $data['idcamp'] = addslashes($_POST['c']);
            $group = addslashes($_POST['a']);
            $camp = addslashes($_POST['c']);
            $data['users'] = $s->listUsers($camp,$group);
        }
  ...
  //       Create a TCP/IP socket.
        ...
        // Registra som
        //'http://gennex.primeccenter.net.br/?usrgnx=mavio&pwdgnx=1234'
    }

    public function logarPlataforma(){
...
//        conectaPlataforma();
    ...
    public function playRecord() {
        ...
        $audio = str_replace('#', '|', strtoupper($audio));
        $audio = 'http://'.AUDIOS.$path.$audio;
